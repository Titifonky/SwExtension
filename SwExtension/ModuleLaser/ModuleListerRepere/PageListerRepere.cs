...
{
    namespace ModuleListerRepere
    {
        [ModuleTypeDocContexte(eTypeDoc.Assemblage | eTypeDoc.Piece),
            ModuleTitre("Lister les repères"),
            ModuleNom("ListerRepere"),
            ModuleDescription("Lister les repères des corps.")
            ]
        public class PageListerRepere : BoutonPMPManager
        {
